...
def parse_args(argv):
    ...
    parser.add_argument(
        ...
        "Supplying a username before an @ without the system-info argument "
        "will default system-info to 'ohai-solo'."
    )
    ...
    ssh_group.add_argument(
        ...
        "system-info argument default system-info to 'ohai-solo'."
    )
    ssh_group.add_argument(
        "-o",
        metavar="ssh_options",
